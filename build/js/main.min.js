...
var _initVideo = require("./modules/init-video");
...
},{"./modules/form-validate/form":3,"./modules/init-map":9,"./modules/init-scroll":10,"./modules/init-swiper":11,"./modules/init-video":12,"./modules/menu-toggle":13,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";
...
var initSwiperIntro = function initSwiperIntro() {
  var swiperIntro = new window.Swiper('.hero__swiper', {
    loop: true,
    speed: 300,
    pagination: {
      el: '.hero__pagination',
...
var initSwiperUpcomingTours = function initSwiperUpcomingTours() {
  var swiperIntro = new window.Swiper('.upcoming-tours__swiper', {
    breakpoints: {
      320: {
        allowTouchMove: true,
        slidesPerView: 1,
