...
var _menuToggle = require("./modules/menu-toggle");
var _initSwiper = require("./modules/init-swiper");
var _initMap = require("./modules/init-map");
var _initScroll = require("./modules/init-scroll");
// ---------------------------------
window.addEventListener('DOMContentLoaded', function () {
  (0, _menuToggle.сloseMenu)();
  (0, _initScroll.getScroll)();
  (0, _initSwiper.initSwiperIntro)();
  (0, _menuToggle.getMenuToggle)();
  // Utils
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    (0, _initSwiper.initSwiperUpcomingTours)();
    (0, _initSwiper.initSwiperEducation)();
    (0, _initSwiper.initSwiperReviews)();
    (0, _initSwiper.initSwiperAdvantages)();
    (0, _initSwiper.initSwiperGallery)();
    (0, _initMap.initMap)();
...
},{"./modules/form-validate/form":3,"./modules/init-map":9,"./modules/init-scroll":10,"./modules/init-swiper":11,"./modules/menu-toggle":13,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
var layer = new window.L.TileLayer('http://{s}.google.com/vt/lyrs=m&x={x}&y={y}&z={z}', {
  minZoom: 10,
...
var marker = window.L.marker([55.774836, 37.632664], markerOptions);
var mapOptions = {
...
exports.initSwiperUpcomingTours = exports.initSwiperReviews = exports.initSwiperIntro = exports.initSwiperGallery = exports.initSwiperEducation = exports.initSwiperAdvantages = void 0;
var _initVideo = require("./init-video");
...
var initSwiperIntro = function initSwiperIntro() {
  var slider = document.querySelector('.hero__swiper');
  if (!slider) {
    return null;
  }
  var _initVideos = (0, _initVideo.initVideos)(),
    _initVideos2 = _slicedToArray(_initVideos, 1),
    youtubePlayer = _initVideos2[0];
  var audioPlayer = slider.querySelector('.hero__audio');
  var audioPlayTemplate = audioPlayer ? audioPlayer.innerHTML : '';
  var swiperIntro = new window.Swiper(slider, {
    ...
    on: {
      slideChange: function slideChange(currentSlider) {
        youtubePlayer.pause();
        var activeSlide = currentSlider.slides[currentSlider.activeIndex];
...
exports.initSwiperIntro = initSwiperIntro;
var initSwiperUpcomingTours = function initSwiperUpcomingTours() {
  var swiperUpcomingTours = new window.Swiper('.upcoming-tours__swiper', {
    breakpoints: {
      320: {
        allowTouchMove: true,
        slidesPerView: 1,
...
exports.initSwiperUpcomingTours = initSwiperUpcomingTours;
var initSwiperEducation = function initSwiperEducation() {
  var swiperEducation = new window.Swiper('.education__swiper', {
    breakpoints: {
      320: {
        allowTouchMove: true,
        slidesPerView: 1,
...
exports.initSwiperEducation = initSwiperEducation;
var initSwiperReviews = function initSwiperReviews() {
  var swiperReviews = new window.Swiper('.reviews__swiper', {
    breakpoints: {
      320: {
        allowTouchMove: true,
        spaceBetween: 30,
...
exports.initSwiperReviews = initSwiperReviews;
var initSwiperAdvantages = function initSwiperAdvantages() {
  ...
  var swiperAdvantages = new window.Swiper('.advantages__swiper', {
    spaceBetween: 30,
    allowTouchMove: false,
    initialSlide: 2,
    centeredSlides: true,
...
exports.initSwiperAdvantages = initSwiperAdvantages;
var initSwiperGallery = function initSwiperGallery() {
  var swiperGallery = new window.Swiper('.gallery__swiper', {
    slidesPerView: 'auto',
    spaceBetween: 5,
    navigation: {
...
exports.initSwiperGallery = initSwiperGallery;

},{"./init-video":12}],12:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initVideos = void 0;
var _loadScript = require("../utils/load-script.js");
var scriptLoaded = false;
var initVideo = function initVideo(containerElement) {
  ...
  if (scriptLoaded) {
    ...
    (0, _loadScript.loadScript)('https://www.youtube.com/player_api', initPlayer, function () {
...
},{"../utils/load-script.js":17}],13:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.сloseMenu = exports.getMenuToggle = void 0;
require("../utils/focus-lock.js");
var nojs = document.querySelector('.nojs');
var btnHeaderElement = document.querySelector('.js-toggle');
var body = document.querySelector('body');
var header = document.querySelector('.header');
var linkHeaderElements = header.querySelectorAll('.navigation__item');
var isFocusLocked = false;
var isEscapeKey = function isEscapeKey(evt) {
  return evt.key === 'Escape';
};
var onDocumentEscKeydown = function onDocumentEscKeydown(evt) {
  if (isEscapeKey(evt)) {
    onCloseMenuClick();
  }
};
...
var onCloseMenuClick = function onCloseMenuClick() {
  header.classList.remove('show-menu');
  body.classList.remove('is-active');
  window.focusLock.unlock('.header');
  isFocusLocked = false;
};
var getMenuToggle = function getMenuToggle() {
  if (nojs) {
...
exports.getMenuToggle = getMenuToggle;
var сloseMenu = function сloseMenu() {
  for (var i = 0; i < linkHeaderElements.length; i++) {
    linkHeaderElements[i].addEventListener('click', onCloseMenuClick);
  }
};
exports.сloseMenu = сloseMenu;

},{"../utils/focus-lock.js":14}],14:[function(require,module,exports){
"use strict";
...
var loadScript = function loadScript(src, handleLoad, callback) {
